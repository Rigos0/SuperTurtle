...
function validateManagedInstance(value, fieldName = "instance") {
  ...
  return {
    ...
    template_version: validateDisplayField(instance.template_version, `${fieldName}.template_version`),
    runtime_version: validateDisplayField(instance.runtime_version, `${fieldName}.runtime_version`),
    project_root: validateDisplayField(instance.project_root, `${fieldName}.project_root`),
