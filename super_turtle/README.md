...
`super_turtle/.env.example` is the reference template. The actual env file is stored in `.superturtle/.env` together with project config and SuperTurtle state, and it is created by `superturtle init`.
