...
- [x] Write docs/oss-security-review.md with findings + actions (include "no issues" if clean).
- [x] Commit.
...
2026-02-27: Added `docs/oss-security-review.md` with scan methodology, reviewed files, findings, completed actions, and residual-risk notes.
