...
Review the hand-written Remotion skill at `super_turtle/skills/.claude/skills/remotion/SKILL.md` — is it solid? If not, improve it. This one IS correctly custom since no official Remotion plugin exists.
...
- [ ] Review the hand-written Remotion skill at `super_turtle/skills/.claude/skills/remotion/SKILL.md` — is it solid? If not, improve it. This one IS correctly custom since no official Remotion plugin exists. <- current
