## Current Task
Implement the next backlog step: style it with dark background, retro look, and mobile-friendly layout.
...
- [ ] Style it: dark background, neon green snake, retro aesthetic, centered on page, mobile-friendly <- current
