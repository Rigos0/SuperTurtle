...
- [ ] Make CompanyPage.js mobile responsive: on screens < 768px, stack cover/logo vertically, make tabs scrollable, reduce padding. Use MUI useMediaQuery or CSS @media. Test the layout at 375px width. <- current
