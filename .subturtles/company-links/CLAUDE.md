...
- [ ] Display company logo next to experience entries: if the experience entry has a matching company (by name or companyId), resolve the company's logoStorageId and show the logo as a small avatar next to the entry. Fallback to BusinessIcon if no logo. <- current
