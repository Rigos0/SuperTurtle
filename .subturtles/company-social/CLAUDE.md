...
- [ ] Create `src/components/company/CompanyPeopleTab.js` — query users whose experienceEntries contain an entry matching the company name (case-insensitive). Display user cards with avatar, name, title. Click navigates to /:username. <- current
