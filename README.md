...
Run either `claude` or `codex` at least once so the CLI can open its authentication/setup flow.

### 2) Clone and open the repo root
...
### 3) Manual info you must provide
